public class Particle {
  ...
  void flow( FlowField flow ) {
    ...
    PVector rFlow = flow.lookup(location, 0.0, frameCount / 120.0);
    PVector gFlow = flow.lookup(location, 2.0, frameCount / 120.0);
    PVector bFlow = flow.lookup(location, 3.0, frameCount/ 150.0);
